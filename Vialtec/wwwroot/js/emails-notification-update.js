$(document).ready(function (e) {
    ...
    // agregar al array los emails que ya existen en el modelo
    $('#emails-container .btn-group .btn-delete-email').each(function (e) {
    ...
    // Llamada inicial para refrescar la tabla
    refreshEmailsTable();
});